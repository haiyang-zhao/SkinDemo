...
import com.zhy.skin_core.R;

public class SkinThemeUtils {

    private final static int[] APPCOMPAT_COLOR_PRIMARY_DARK_ATTRS = {
            R.attr.colorPrimaryDark
    };
    private final static int[] STATUS_BAR_COLOR_ATTRS = {android.R.attr.statusBarColor, android.R.attr
            .navigationBarColor
    };
